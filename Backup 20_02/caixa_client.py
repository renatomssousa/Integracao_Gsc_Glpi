...
def _log_retorno_tipo4(soap_response_xml: str) -> None:
    ...
    if processado is not None:
        if processado.lower() == "true":
            ...
            print(f"Retorno tipo 4 NAO OK (processado={processado}).")
...
def set_aceite_recusa(
    ...
    tipo_aceite = "1" if aceite else "2"
        ...
        <urn:SetAceiteRecusa>
          <urn:arquivoxml>
            ...
            <urn:retorno>
              ...
              <urn:tipo_aceite>{tipo_aceite}</urn:tipo_aceite>
    ...
    return _post_soap(xml, "SetAceiteRecusa")


def _build_anexos_xml(anexos: Optional[List[Dict[str, str]]]) -> str:
    """
    WSDL: suporta 3 anexos:
      nome_arquivo1 + anexo1, nome_arquivo2 + anexo2, nome_arquivo3 + anexo3
    """
    if not anexos:
        return ""
    ...
    for i, ax in enumerate(anexos, start=1):
        ...
        b64 = "".join(b64.split())  # remove espacos e quebras
      ...
      <soapenv:Body>
        <urn:SetAtualizacao>
          <urn:arquivoxml>
            ...
            <urn:info_fornecedor>
              <urn:idfornecedor>SGP000000124811</urn:idfornecedor>
              <urn:nomefornecedor>PETACORP</urn:nomefornecedor>
            </urn:info_fornecedor>
